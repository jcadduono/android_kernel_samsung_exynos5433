#!/bin/bash
# Samsung kernel for Samsung Exynos 5433 devices build script by jcadduono
...
# gts28wifi  = SM-T710
# tre3g      = SM-N910H
# trelte     = SM-N910C, SM-N910U
#
###################### CONFIG ######################

# root directory of universal5433 kernel git repo (default is this script's location)
RDIR=$(pwd)
